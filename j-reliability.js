(()=>{
  ...
  const state={health:null,lastCommand:null,lastCommandAt:0,lastError:'',checks:0};
  ...
  window.JReliability={state,checkHealth,checkCommand,ensureBridges,setError};setTimeout(tick,800);
})();
